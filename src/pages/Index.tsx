...
const Index = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-background">
      ...
      >
        ...
        >
          ...
          <img
            src={heroImage}
            alt="Quran"
            className="hero-image absolute inset-0 h-full w-full object-cover opacity-5"
          />
        </motion.div>

        {/* Animated background orbs - Islamic colors */}
        <motion.div
          className="absolute top-10 right-10 w-96 h-96 bg-emerald-500/5 rounded-full blur-3xl"
          animate={{ y: [0, -40, 0], x: [0, 30, 0] }}
          transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute bottom-10 left-10 w-96 h-96 bg-amber-500/5 rounded-full blur-3xl"
          animate={{ y: [0, 30, 0], x: [0, -30, 0] }}
          transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute top-1/2 right-1/4 w-80 h-80 bg-emerald-500/3 rounded-full blur-3xl"
        ...
        <div className="container relative z-10 mx-auto px-4">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="mb-6 inline-block">
              <motion.div
                className="inline-flex items-center gap-2 rounded-full glass px-5 py-2.5 hover:bg-white/10 transition-all duration-300 border border-emerald-500/30 hover:border-emerald-500/60"
                whileHover={{ boxShadow: "0 0 30px rgba(16, 164, 84, 0.3)" }}
              >
                <motion.span
                ...
                >
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-500/70"></span>
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-400"></span>
                </motion.span>
                <span className="text-sm font-semibold text-emerald-400">Certified Qari & Hafiz</span>
              </motion.div>
            </motion.div>
            ...
            >
              <span className="text-gradient-premium block mb-2">
                Qari Muhammad
              </span>
              <span className="bg-gradient-to-r from-emerald-400 via-amber-400 to-emerald-400 bg-clip-text text-transparent block">
                Nadeem Majeed
              </span>
            </motion.h1>
            ...
            <motion.p
              variants={itemVariants}
              className="hero-subtitle font-urdu mb-6 text-2xl md:text-3xl text-emerald-400"
            >
            ...
            >
              <motion.div
                whileHover={{ scale: 1.05, boxShadow: "0 0 40px rgba(16, 164, 84, 0.5)" }}
                whileTap={{ scale: 0.95 }}
              >
                <Button
                  asChild
                  size="lg"
                  className="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 text-white font-bold text-base shadow-neon"
                >
                  <Link to="/booking">
              ...
              >
                <Button
                  asChild
                  size="lg"
                  className="glass border-emerald-500/50 text-white hover:border-emerald-400 hover:bg-white/10 font-semibold text-base"
                >
                  <Link to="/about">
                    Learn More About Me
                  </Link>
        ...
        <div ref={statsRef} className="container relative z-10 mx-auto px-4 mt-20 md:mt-32">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {stats.map((stat, index) => (
              <motion.div
                key={stat.label}
                className="stat-item glass rounded-xl p-6 text-center border border-emerald-500/20 hover:border-emerald-500/60 hover:bg-white/10 transition-all duration-300"
                whileHover={{ y: -8, boxShadow: "0 0 30px rgba(16, 164, 84, 0.3)" }}
              >
                <stat.icon className="mx-auto mb-3 h-8 w-8 text-emerald-400" />
                <p className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-emerald-400 to-amber-400 bg-clip-text text-transparent mb-2">{stat.number}</p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-white/70 max-w-2xl mx-auto">
              Comprehensive Quran education with proven methodologies and expert guidance
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-2xl glass border border-emerald-500/20 p-8 hover:border-emerald-500/60 hover-glow-emerald transition-all duration-300"
              >
                <motion.div
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                  className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500/20 to-amber-500/20 text-emerald-400 group-hover:from-emerald-500 group-hover:to-amber-500 group-hover:text-white transition-all"
                >
      ...
      {/* Services Section */}
      <section ref={servicesRef} className="py-16 md:py-24 bg-gradient-to-b from-background to-emerald-950/10">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <Button
              asChild
              size="lg"
              className="bg-gradient-to-r from-emerald-600 to-amber-500 hover:shadow-neon text-white font-bold"
            >
              <Link to="/courses">
                View All Courses
              </Link>
      ...
      <section className="py-16 md:py-24 bg-background relative">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="font-urdu mx-auto max-w-2xl text-xl text-emerald-400/80">
          ...
          >
            <Button
              ...
              size="lg"
              variant="outline"
              className="glass border-emerald-500/50 text-white hover:border-emerald-400 hover:bg-white/10"
            >
      ...
      <section className="relative overflow-hidden py-16 md:py-24">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          >
            <motion.div className="mb-6 inline-flex items-center gap-2 text-emerald-400">
            ...
            <p className="font-urdu mb-6 text-xl text-emerald-400/80">
